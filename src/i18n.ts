...
const ZH_STRINGS = {
  ...
  'hud.replay.pause': '暂停',
  'hud.replay.resume': '继续',
  'hud.replay.step': '单步',
  'hud.replay.continueFromHere': '从此处继续游戏',
  'hud.replayAgain': '重播',
  'hud.loadReplay': '载入录像',
  'hud.winner.draw': '平局',
  'hud.winner.p1': '您获胜',
  ...
  // game info panel
  'hud.info.heading': '游戏参数',
  'hud.info.p1Coins': '玩家硬币',
  'hud.info.p2Coins': '对手硬币',
  'hud.info.stones': '石头',
  'hud.info.bombs': '炸弹',
  'hud.info.holes': '陷阱',
  'hud.info.trees': '树木',
  'hud.info.coinRadius': '硬币半径',
  'hud.info.coinMass': '硬币质量',
  'hud.info.maxSpeed': '最大速度',
  'hud.info.aiDifficulty': 'AI难度',
  'hud.info.keepShotOnKill': '杀敌续弹',
  'hud.info.explosionRadius': '爆破半径',
  'hud.info.on': '开',
  'hud.info.off': '关',
...
const EN_STRINGS: Record<keyof typeof ZH_STRINGS, string> = {
  ...
  'chrome.backToWelcome': 'Back to Menu',
  ...
  'welcome.footer': 'Freeware — please share.',
  ...
  'hud.replay.pause': 'Pause',
  'hud.replay.resume': 'Resume',
  'hud.replay.step': 'Step',
  'hud.replay.continueFromHere': 'Continue from here',
  'hud.replayAgain': 'Replay Again',
  'hud.loadReplay': 'Load Replay',
  ...
  // game info panel
  'hud.info.heading': 'Settings',
  'hud.info.p1Coins': 'P1 coins',
  'hud.info.p2Coins': 'P2 coins',
  'hud.info.stones': 'Stones',
  'hud.info.bombs': 'Bombs',
  'hud.info.holes': 'Holes',
  'hud.info.trees': 'Trees',
  'hud.info.coinRadius': 'Coin radius',
  'hud.info.coinMass': 'Coin mass',
  'hud.info.maxSpeed': 'Max speed',
  'hud.info.aiDifficulty': 'AI level',
  'hud.info.keepShotOnKill': 'Keep turn',
  'hud.info.explosionRadius': 'Explosion R.',
  'hud.info.on': 'On',
  'hud.info.off': 'Off',
...
const JA_STRINGS: Record<keyof typeof ZH_STRINGS, string> = {
  ...
  'hud.replay.pause': '一時停止',
  'hud.replay.resume': '再開',
  'hud.replay.step': 'ステップ',
  'hud.replay.continueFromHere': 'ここから続ける',
  'hud.replayAgain': 'もう一度再生',
  'hud.loadReplay': '別のリプレイを開く',
  ...
  // game info panel
  'hud.info.heading': '設定',
  'hud.info.p1Coins': 'P1コイン',
  'hud.info.p2Coins': 'P2コイン',
  'hud.info.stones': '石',
  'hud.info.bombs': '爆弾',
  'hud.info.holes': '穴',
  'hud.info.trees': '木',
  'hud.info.coinRadius': 'コイン半径',
  'hud.info.coinMass': 'コイン質量',
  'hud.info.maxSpeed': '最大速度',
  'hud.info.aiDifficulty': 'AIレベル',
  'hud.info.keepShotOnKill': '撃破継続',
  'hud.info.explosionRadius': '爆発半径',
  'hud.info.on': 'ON',
  'hud.info.off': 'OFF',
...
const ES_STRINGS: Record<keyof typeof ZH_STRINGS, string> = {
  ...
  'welcome.footer': 'Software gratuito — compártelo.',
